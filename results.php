...
<div class="content_wraper" style="margin-bottom: 500px">
	...
	<div id="product_page">
       ...
       $get_products= mysqli_query($himel, "SELECT * FROM products WHERE keywords LIKE '%$user_keyword%' OR title LIKE '%$user_keyword%' OR description LIKE '%$user_keyword%' LIMIT 0,6");
			if(mysqli_num_rows($get_products) > 0){
				while($res = mysqli_fetch_assoc($get_products)){
					echo"
		<div id='single_product'>
		<h3  style='color:#3C0'>".$res['title']."</h3>
		<img src='admin/product_image/".$res['img1']."'
		 width='250' height='300'/>
		 <p style='color:#000'><b>Price:৳ ".$res['price']."</b></p>
	 	<a href='details.php?pro_id=".$res['product_id']."' style='float:left;text-decoration: none;color:#222327';><b>Details</b></a>
		 <a href='payment.php?add_cart=".$res['product_id']."'><button  style='float:right;background:#FB3A3E; height: 30px;width: 80px;color: #F7F0F0;  border:hidden';>Add to Cart</button></a></div>";
				}
			}
