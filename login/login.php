...
input[type=text] {
   ...
   border: hidden;
    ...
    transition: width 0.4s ease-in-out;
       ...
       <div class="dropdown">
		  <a href="../index.php"><button  class="dropbtn" ><b>Shop</b></button></a>
  ...
  <form action="../admin/login_user.php" method="POST">
    <div class="row">
      ...
      <div class="col">
        ...
        <div align="left" style=""> User Email :    <input type="text"  style="background: #FFFFFF; width: 450px;"class="inputvalues"  placeholder="Type Your Email" name="name"/>    </div><br/>
			...
			<div align="center">            <input type="submit"  name="signin" value="Login"/>
...
<div class="bottom-container" style="margin-bottom: 300px;">
  <div class="row">
    <div class="col">
      <a href="registation.php" style="color:white" class="btn">Sign up</a>
    </div>
    <div class="col">
